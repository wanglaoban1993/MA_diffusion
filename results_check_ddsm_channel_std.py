...
# output_dir = "path_simulation_plots_std/reflection"
...
# def compute_kl_and_wasserstein(merged_samples, num_channels, beta_values, alpha=1, num_iterations=10):
#     """
...
# def plot_metric_summary(metric_results, metric_name):
#     """Plot the mean and standard deviation of a metric for each channel."""
#     num_channels = len(metric_results)
#     means = [result[0] for result in metric_results]
#     stds = [result[1] for result in metric_results]
    
#     plt.figure(figsize=(12, 6))
#     plt.bar(range(num_channels), means, yerr=stds, capsize=5, alpha=0.7, label=f'{metric_name} Mean')
#     plt.xlabel('Channel')
#     plt.ylabel(metric_name)
#     plt.title(f'{metric_name} Mean and Standard Deviation for Each Channel')
#     plt.xticks(range(num_channels), [f'Channel {i+1}' for i in range(num_channels)])
#     plt.legend()
#     plt.grid(True)
...
# # Example usage
# file_path = './sudoku/steps400.cat9.time1.0.samples50000_reflection.pth'
...
# # Plot summary of KL divergence and Wasserstein distance
# plot_metric_summary(kl_results, 'KL Divergence')
# plot_metric_summary(wasserstein_results, 'Wasserstein Distance')
...
# Ensure the directory exists
output_dir = "path_simulation_plots_std800/s1/reflect_boundaries"
os.makedirs(output_dir, exist_ok=True)
...
# Example usage
file_path = './sudoku/steps800.cat9.time1.0.samples50000_reflect_boundaries_s1.pth'
merged_tensor, timepoints, num_samples, num_channels = load_and_process_data(file_path)

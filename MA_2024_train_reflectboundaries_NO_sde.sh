...
+ here is running steps400.cat9.time1.0.samples50000_reflect_boundaries.pth, 
+ reflectboundaries_NO_sde,
...
python3 ${SLURM_SUBMIT_DIR}/sudoku/train_sudoku_reflectboundaries_NO_sde.py 
"
